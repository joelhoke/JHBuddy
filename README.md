...
Click the buddy to cycle expressions, double-click for a confirmation sound, and drag it to reposition it. Hold it for 0.65 seconds to open its options menu, including expression selection and Close Buddy. Use the `◉` menu-bar icon to show a closed buddy, select an expression, or enable click-through mode. Its last position is remembered.
